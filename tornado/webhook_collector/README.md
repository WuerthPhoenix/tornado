...
- _max_payload_bytes_ (optional):  This value defines the maximum size in bytes of the payload sent
  to the collector. If not provided, it will default to 5MB (5_242_880 bytes).
...
The value for __max_payload_bytes__ is optional, and in our case will reduce the maximum payload size
to about 2MB.
