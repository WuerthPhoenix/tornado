...
impl AccessorBuilder {
    ...
    pub fn build(&self, rule_name: &str, input: &str) -> Result<Accessor, MatcherError> {
        ...
        let parser_builder = ParserBuilder::default()
            ...
            .add_parser_factory(FOREACH_ITEM_KEY.to_owned(), Box::new(ItemParser::new));
...
impl CustomParser<String> for ItemParser {
    fn parse_value<'o>(&'o self, _value: &'o Value, _context: &String) -> Option<Cow<'o, Value>> {
