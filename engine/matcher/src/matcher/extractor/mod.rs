...
#[derive(Debug)]
enum ValueExtractor {
    RegexSingleMatchSingleGroup {
        scoped_key: String,
        regex: RustRegex,
        group_match_idx: usize,
        target: Accessor,
    },
    RegexAllMatchesSingleGroup {
        scoped_key: String,
        regex: RustRegex,
        group_match_idx: usize,
        target: Accessor,
    },
    RegexSingleMatchAllGroups {
        scoped_key: String,
        regex: RustRegex,
        target: Accessor,
    },
    RegexAllMatchesAllGroups {
        scoped_key: String,
        regex: RustRegex,
        target: Accessor,
    },
    RegexSingleMatchNamedGroups {
        scoped_key: String,
        regex: RustRegex,
        target: Accessor,
    },
    RegexAllMatchesNamedGroups {
        scoped_key: String,
        regex: RustRegex,
        target: Accessor,
    },
...
impl ValueExtractor {
        ...
        match &extractor.regex {
            ...
            ExtractorRegex::RegexNamedGroups { regex, all_matches } => {
                ...
                if all_matches.unwrap_or(false) {
                    ...
                    Ok(ValueExtractor::RegexSingleMatchNamedGroups {
                        regex: rust_regex,
                        scoped_key,
                        target,
                    })
    ...
    pub fn extract(
        ...
        match self {
            ...
            ValueExtractor::RegexSingleMatchSingleGroup {
            ...
            ValueExtractor::RegexAllMatchesSingleGroup {
                regex, group_match_idx, target, ..
            } => {
                let cow_value = target.get(event, extracted_vars)?;
                let text = cow_value.get_text()?;
