...
impl DirectorExecutor {
    ...
    pub async fn perform_request(
        ...
        {
            info!("DirectorExecutor - Icinga Director API returned an error, object seems to be already existing. Response status: {}. Response body: {}", response_status, response_body);
            Ok(())
